...
object SeedData {
    ...
    // Unsplash photos (free license, attribution listed in the report references)
    private const val IMAGE_ESPRESSO =
        "https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=800&q=80&fm=jpg"
    private const val IMAGE_ICED_AMERICANO =
        "https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=800&q=80&fm=jpg"
    private const val IMAGE_OAT_LATTE =
